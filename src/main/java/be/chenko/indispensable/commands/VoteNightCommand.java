...
public class VoteNightCommand implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (util.uuidInArrayNight(player.getUniqueId())){
            player.sendMessage(ChatColor.DARK_PURPLE + "You have already voted.");
            return true;
        }
        player.sendMessage(ChatColor.LIGHT_PURPLE + "You have voted for "+ChatColor.AQUA+"night"+ChatColor.LIGHT_PURPLE+"!");
        util.addPlayerToVoteNight(player.getUniqueId());
        return true;
    }
}
